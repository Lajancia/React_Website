...
function GlassCareerCard() {
    ...
    <CardContent style={{backdropFilter: 'blur(0px)'}} >
        ...
        <br/>
        <Grid container spacing={2} justifyContent="center" alignItems="center" m={4} >
        <Grid xs={12} sm={3}>
            <Typography variant="h3" component="div" forWeight="bold" align="center">
            WORK
            </Typography>
        </Grid>
        <Grid xs={12} sm={9}>
            <Typography variant="h5" component="div" forWeight="bold" align="left"  color="#F5564E" mb={2} sx={{fontWeight:'bold'}}>
            (주)유라
            </Typography>
            <Typography variant="caption" component="div" forWeight="bold" align="left" mb={2}>
                2022.10 ~ 현재
            </Typography>
            <Typography variant="subtitle1" component="div" forWeight="bold" align="left" mb={2}>
            ...
            <br/>
            <Typography variant="subtitle1" component="div" forWeight="bold" align="left" mb={2} color="#FAB95B">
       ...
       <Grid container spacing={2} justifyContent="center" alignItems="center" m={4} >
        <Grid xs={12} sm={3}>
            <Typography variant="h4" component="div" forWeight="bold" align="center">
            INTERN
            </Typography>
        </Grid>
        <Grid xs={12} sm={9}>
